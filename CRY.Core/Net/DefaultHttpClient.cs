...
namespace CRY.Core.Net {
    public class DefaultHttpClient : HttpClientBase {
        #region fields
        ...
        public DefaultHttpClient(string url, HttpClientContext context)
        ...
        public DefaultHttpClient(string url, HttpClientContext context, bool keepContext) {
            Url = url;
